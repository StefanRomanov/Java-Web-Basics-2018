...
public class ApplicationLoadingService {
                    ...
                    if (extractedMethod.getName().equals("service")) {
                        ...
                        Object proxyResponse = Proxy.newProxyInstance(
                                ...
                                (responseProxy, responseMethod, responseArgs) -> {
                                    Method extractedRequestMethod = Arrays.stream(args[1]
                                            .getClass()
                                            .getMethods())
                                    ...
                                    return extractedRequestMethod.invoke(args[1], responseArgs);
    ...
    private void loadClass(File currentFile, URLClassLoader classLoader,String applicationName, String packageName) throws IOException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {

        if(currentFile.isDirectory()){
            for (File childFile : currentFile.listFiles()) {
                this.loadClass(childFile,classLoader, applicationName,
    ...
    private void loadApplicationLibraries(String libRootFolderPath, String applicationName) throws IOException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        this.libraryClassUrls = new ArrayList<>();

        File libraryFolder = new File(libRootFolderPath);
    ...
    private void loadApplicationFromFolder(String applicationRootFolderPath, String applicationName)
        ...
        String libRootFolderPath = applicationRootFolderPath + "lib" + File.separator;

        this.loadApplicationLibraries(libRootFolderPath,applicationName);
