...
public class ControllerLoadingService {
    ...
    private void loadClass(File currentFile, URLClassLoader classLoader, String packageName) throws
    ...
    public void loadControllerActionHandlers(String applicationClassesPath) throws NoSuchMethodException, IOException, InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
        this.initMap();
        this.loadApplicationClasses(applicationClassesPath);
    }
}
