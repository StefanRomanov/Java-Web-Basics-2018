...
public class JavacheConfigService {
    private static final String CONFIG_FOLDER_PATH = WebConstants.SERVER_ROOT_FOLDER + "config/";
    ...
    private void loadRequestHandlerConfig() throws IOException {
        ...
        String configFileContent = new Reader()
                .readAllLines(new BufferedInputStream(new FileInputStream(priorityConfigFile)));

        this.requestHandlerPriority = Arrays
